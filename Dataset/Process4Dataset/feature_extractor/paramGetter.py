...
if __name__ == '__main__':
    ...
    # np.save(param_cache_path, np.array({"None" : [0, 0, 0, 0, 0, 0, 0]}))
    # with open(param_cache_path, "w", encoding='utf-8') as f:
    # f.write(json.dumps({"None" : [0, 0, 0, 0, 0, 0, 0]}, ensure_ascii=False, indent=4))
