...
model_save_dir = "DeepLearning/Models/Extraction_BioInfo_MultipleRegression/best_models/"
storage = "sqlite:///LinuxDB/DeepLearning/Extraction_BioInfo_MultipleRegression.sqlite3"
...
def ESM3B():
    ...
    from DeepLearning.Models.Extraction_BioInfo_MultipleRegression.Model import (
        ESM3B_AttentionNet_BioInfo_Sub,
        ESM3B_AttentionNet_BioInfo_Comb,
        ESM3B_ConvNet_BioInfo_Sub,
        ESM3B_ConvNet_BioInfo_Comb)
    # print("ESM3B-Attention-BioInf-Subtration(MultipleRegression)")
    # study01 = optuna.create_study(study_name="ESM3B-Attention-BioInf-Subtration(MultipleRegression)",
    ...
    print("ESM3B-Attention-BioInf-Combnation(MultipleRegression)")
    ...
    print("ESM3B-Conv-BioInf-Subtration(MultipleRegression)")
    ...
    print("ESM3B-Conv-BioInfo-Combnation(MultipleRegression)")
...
def ESM650M():
    ...
    print("ESM650M-Attention-BioInf-Subtration(MultipleRegression)")
    ...
    print("ESM650M-Attention-BioInf-Combnation(MultipleRegression)")
    ...
    print("ESM650M-Conv-BioInf-Subtration(MultipleRegression)")
    ...
    print("ESM650M-Conv-BioInfo-Combnation(MultipleRegression)")
...
def ProtBert():
    ...
    print("ProtBert-Attention-BioInf-Subtration(MultipleRegression)")
    ...
    print("ProtBert-Attention-BioInf-Combnation(MultipleRegression)")
    ...
    print("ProtBert-Conv-BioInf-Subtration(MultipleRegression)")
    ...
    print("ProtBert-Conv-BioInfo-Combnation(MultipleRegression)")
